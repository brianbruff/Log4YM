...
import { Map as MapIcon, MapPin, Target, Maximize2, ZoomIn, ZoomOut, Layers, Satellite } from 'lucide-react';
            ...
            return (
              <div key={name}>
                ...
                <Circle
                  ...
                  radius={position.footprintRadius * 1000} // Convert km to meters
                  pathOptions={{
                    color: '#ec4899',
                    fillColor: '#ec4899',
                    fillOpacity: 0.08,
